...
import { Book, Sparkles, Volume2, ArrowLeft, BrainCircuit, Timer, Footprints, Info } from "lucide-react";
          ...
          <CardContent className="flex flex-col items-center gap-8">
            ...
            <div className="w-full text-center">
                ...
                <p className="mt-2 text-muted-foreground">
                 ...
                 <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4 w-full mt-6">
                    <Button
                        variant="outline"
                        size="lg"
